...
<section class="splide pb-md-5 mb-md-5 width_90" id="slider-related-posts" aria-label="related-posts slider">
        <div class="splide__track">
			...
			foreach($results as $row) :
				...
				$character_limit = 50; // Change this to your desired character limit
                $trimmed_content = mb_strimwidth($row->post_content, 0, $character_limit, '...');
		?>
                    <li class="splide__slide">
                       <div class="news-block">
								...
								<div class="news-info">
									...
									<p class="news-content"><?php echo $trimmed_content; ?></p>
