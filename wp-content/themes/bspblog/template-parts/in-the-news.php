					...
					while ($query->have_posts()) :
						...
						?> 
							<div class="single-news col-md-4 <?php echo $currentClass;?>">								
								<div class="news-info">
								<h4 class="news-details"><a href="<?php echo $link;?>" target="<?php echo  $target;?>" ><?php echo strip_tags($short_desc);?></a></h4>
								</div>
							</div>
					<?php 
                $counter++;
			...
			if ($query->have_posts()) :
                $options = array('gray-tile', 'red-tile', 'blue-tile');
					while ($query->have_posts()) :
						...
						?>     
        <h4 class="news-details <?php echo $currentClass;?>"><a href="<?php echo $link;?>" target="<?php echo  $target;?>" ><?php echo strip_tags($short_desc);?></a></h4>
        <?php 
        $counter++;
        endwhile;
wp_reset_postdata();
