...
$show_type=!empty($_GET['show_type'])?$_GET['show_type']:'show-type-grid';
			...
			<?php endif;?>
                ...
                <div class="pagination">
                    ...
                    echo paginate_links(array(
                        ...
                        'current' => $paged,
                        'base' => add_query_arg('show_type', 'show-type-grid', $base_url . '%_%'),
                        'format' => '?paged=%#%',
                        'prev_text' => '&laquo;',
                        'next_text' => '&raquo;',
                    ));
...
wp_reset_postdata();
    ...
    <div class="pagination">
                    ...
                    echo paginate_links(array(
                        'total' => $query->max_num_pages,
                        'current' => $paged,
                        'base' => add_query_arg('show_type', 'show-type-list', $base_url . '%_%'),
                        'format' => '?paged=%#%',
                        'prev_text' => '&laquo;',
                        'next_text' => '&raquo;',
                    ));
