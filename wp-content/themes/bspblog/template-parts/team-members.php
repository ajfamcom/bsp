...
<div class="single-team-member col-md-3">
    <img class="member-image" src="<?php echo $image['url'];?>" width="200px;"/>
...
<?php endwhile; ?>
<?php endif;?>
<div class="col-12 text-center"><a href="#."><button type="button" class="btn btn-primary">MEET THE TEAM</button></a></div>
</div>
