...
?>
<!--<form role="search" <?php echo $twentytwentyone_aria_label; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form" action="#.">
	...
	<input type="button" id="search-data-btn" class="search-submit" value="<?php //echo esc_attr_x( 'Search', 'submit button', 'twentytwentyone' ); ?>" style="background:black;padding:13px;color:white;font-size:20px;cursor:pointer;"/>
</form>
