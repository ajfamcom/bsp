...
if (!empty($search_keyword)) {
  $total_items = $wpdb->get_var("SELECT COUNT(*) FROM wp_searchdata WHERE keyword LIKE '%$search_keyword%' LIMIT 10");
}
else{
 echo   $total_items = $wpdb->get_var("SELECT COUNT(*) FROM wp_searchdata LIMIT 10");
}
