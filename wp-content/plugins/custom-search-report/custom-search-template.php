...
<div class="container mt-5">
  ...
  <form method="get" action="<?php echo esc_url($current_admin_url); ?>">
    ...
    <button type="button" class="custom-search-button btn btn-primary" onclick="location.href='<?php echo admin_url('admin.php') . '?page=search-report-download-csv'; ?>'">Download CSV</button>
